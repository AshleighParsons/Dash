...
class ItemActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab_item.setOnClickListener {
            ...
            val toDoName = view.findViewById<EditText>(R.id.ev_task)
            dialog.setView(view)
...
//    }
    ...
    private fun refreshList() {
        rv_item.adapter =
            ItemAdapter(this, dbHandler.getToDoItems(todoId))
    }
    ...
    class ItemAdapter(val activity: ItemActivity, val list: MutableList<ToDoItem>) :
        ...
        override fun onBindViewHolder(holder: ViewHolder, p1: Int) {
            ...
            holder.delete.setOnClickListener{
                ...
                dialog.setTitle("Delete this task")
